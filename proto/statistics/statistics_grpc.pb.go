...
type StatisticsServiceClient interface {
	GetUserOrdersStatistics(ctx context.Context, in *UserOrdersStatisticsRequest, opts ...grpc.CallOption) (*UserOrdersStatisticsResponse, error)
...
func (c *statisticsServiceClient) GetUserOrdersStatistics(ctx context.Context, in *UserOrdersStatisticsRequest, opts ...grpc.CallOption) (*UserOrdersStatisticsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserOrdersStatisticsResponse)
...
type StatisticsServiceServer interface {
	GetUserOrdersStatistics(context.Context, *UserOrdersStatisticsRequest) (*UserOrdersStatisticsResponse, error)
...
func (UnimplementedStatisticsServiceServer) GetUserOrdersStatistics(context.Context, *UserOrdersStatisticsRequest) (*UserOrdersStatisticsResponse, error) {
...
func _StatisticsService_GetUserOrdersStatistics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserOrdersStatisticsRequest)
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatisticsServiceServer).GetUserOrdersStatistics(ctx, req.(*UserOrdersStatisticsRequest))
	}
